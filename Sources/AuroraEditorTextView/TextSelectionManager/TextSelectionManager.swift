...
public class TextSelectionManager: NSObject {
    ...
    public static let selectionChangedNotification: Notification.Name = Notification.Name("com.AuroraEditor.TextSelectionManager.TextSelectionChangedNotification")
