...
public class AEUndoManager {
    /// An `UndoManager` subclass that forwards relevant actions to a `AEUndoManager`.
    /// Allows for objects like `TextView` to use the `UndoManager` API
    /// while AETV manages the undo/redo actions.
    public class DelegatedUndoManager: UndoManager {
        weak var parent: AEUndoManager?
